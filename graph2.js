...
//classes
but.classList.add('waves-effect', 'waves-light', 'btn','cli', 'pup');
butHour.classList.add('waves-effect', 'waves-light', 'btn','cli','pup');
butDay.classList.add('waves-effect', 'waves-light', 'btn','cli','pup');
